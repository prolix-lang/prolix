/* Generated code for Python module 'readchar$_posix_key'
...
/* The "module_readchar$_posix_key" is a Python object pointer of module type.
 *
...
PyObject *module_readchar$_posix_key;
PyDictObject *moduledict_readchar$_posix_key;
...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("readchar._posix_key"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_readchar$_posix_key(PyThreadState *tstate) {
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_726ccdfa7f715e275e9f27723bbf3a64 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[67], mod_consts[67], NULL, NULL, 0, 0, 0);
}
...
static function_impl_code const function_table_readchar$_posix_key[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_readchar$_posix_key);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_readchar$_posix_key,
        sizeof(function_table_readchar$_posix_key) / sizeof(function_impl_code)
    );
}
...
PyObject *modulecode_readchar$_posix_key(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("readchar$_posix_key");

    // Store the module for future use.
    module_readchar$_posix_key = module;
    ...
    if (init_done == false) {
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("readchar$_posix_key: Calling setupMetaPathBasedLoader().\n");
#endif
        ...
        NUITKA_PRINT_TRACE("readchar$_posix_key: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
#if defined(_NUITKA_MODULE) && 0
    PyObject *pre_load = IMPORT_EMBEDDED_MODULE(tstate, "readchar._posix_key" "-preLoad");
    if (pre_load == NULL) {
        return NULL;
    }
#endif

    // PRINT_STRING("in initreadchar$_posix_key\n");

    moduledict_readchar$_posix_key = MODULE_DICT(module_readchar$_posix_key);
...
#ifdef _NUITKA_PLUGIN_DILL_ENABLED
    {
        ...
        if (loader_entry != NULL) {
            ...
            PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___name__);
    ...
    UPDATE_STRING_DICT0(
        moduledict_readchar$_posix_key,
    ...
    CHECK_OBJECT(module_readchar$_posix_key);

    // For deep importing of a module we need to have "__builtins__", so we set
    // it ourselves in the same way than CPython does. Note: This must be done
    // before the frame object is allocated, or else it may fail.

    if (GET_STRING_DICT_VALUE(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___builtins__, value);
    }

    UPDATE_STRING_DICT0(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, _spec_from_module, module_readchar$_posix_key);
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_readchar$_posix_key, (Nuitka_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict_readchar$_posix_key, (Nuitka_StringObject *)mod_consts[0], tmp_assign_source_1);
    }
    {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_726ccdfa7f715e275e9f27723bbf3a64);
    ...
    }
    {
        ...
        tmp_result = IMPORT_MODULE_STAR(tstate, module_readchar$_posix_key, true, tmp_star_imported_1);
    ...
    }
    {
        ...
        if (unlikely(tmp_assign_source_31 == NULL)) {
            tmp_assign_source_31 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[63]);
        }
    ...
    frame_no_exception_1:;
    {
        ...
        if (unlikely(tmp_assign_source_32 == NULL)) {
            tmp_assign_source_32 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[22]);
        }
    ...
    PGO_onModuleExit("readchar$_posix_key", false);

    Py_INCREF(module_readchar$_posix_key);
    return module_readchar$_posix_key;
